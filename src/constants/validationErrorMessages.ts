...
export const passMustnotHaveSpaces = "Пароль не должен содержать пробелы"
export const fioMustHaveOnlyLettersAndBeSeparatedBySpaces = "ФИО должно содержать только латинницу и быть разделено пробелами"